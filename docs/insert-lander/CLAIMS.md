...
| Imperial College fMRI: "the part of the brain that monitors and second-guesses you went quiet… 21 of 31 reported more desire over the next day, 8 on placebo" | Thurston et al., *J Clin Invest* 2022;132(19):e152341 (PMID 36189794) — randomized double-blind crossover, n=31 premenopausal women with HSDD, 1.75mg vs placebo, fMRI at 45 and 240 min. 21/31 vs 8/31 reported increased desire in the following 24h, P=0.007. Authors: it "enhanced sexual brain processing by reducing self-consciousness, increasing sexual imagery, and sensitizing women with HSDD to erotic stimuli," with deactivation of secondary somatosensory cortex letting women "relax their higher-level control and self-monitoring." **Independent of the manufacturer.** | TRIAL |
| "finer than the one inside the branded auto-injector" | Vyleesi's autoinjector uses a **29-gauge ½-inch** staked needle (FDA CDER Chemistry Review, NDA 210557). A standard 30–31G insulin syringe is finer. | LABEL/review |
| "most women used it two or three times a month" | Label §14: "Most patients used VYLEESI two to three times per month and no more than once a week." Median 10 injections over the 24-week double-blind period. | LABEL |
| Avoidance beat — women going to bed after their husband was asleep; "no other stressors, no issues in our life" | FDA *Voice of the Patient: Female Sexual Dysfunction* (June 2015), verbatim participant testimony. Public domain. | PATIENT TESTIMONY |

**Numbers deliberately NOT used, and why (updated):**
- **Ondansetron premedication does NOT work** and must never be suggested. A 228-woman randomized trial found no reduction in nausea; the label states prophylactic oral ondansetron "is not recommended."
- **"34% of men who failed Viagra responded"** — traces to Safarinejad 2008, now carrying a *J Urol* Expression of Concern; the same author's other bremelanotide paper was fully retracted and he has 15 retractions. Widespread in competitor copy. Do not repeat.
- **"Effects last 6–24 hours"** — the label says duration of efficacy is *unknown*. The only real 24-hour signal is Thurston's self-reported desire measure, which is a desire report, not a duration of action.
- **Nausea is front-loaded, and honest framing matters:** 40% is the cumulative rate across 24 weeks; per-dose it is **21% on the first dose falling to ~3% after**, and the label states "nausea improves for most patients with the second dose." Quoting 40% without that is as misleading as omitting it.
...
| ~~"about 45 minutes ahead"~~ — **no longer in the copy, and do not reintroduce it as an onset claim** | The label's "at least 45 minutes before anticipated sexual activity" is a *dosing instruction*, not a measured time-to-effect. FDA's clinical pharmacology review states the 45 minutes "is based on the observed Tmax of 1.0 hour... and is consistent with instructions given to subjects in phase 3 trials" — i.e. a PK curve plus the trial protocol. FDA **refused** the sponsor's proposed duration claim and required the label to say the optimal window "has not been fully characterized"; the review states plainly that "the duration of effect on desire is unknown." Writing "works in 45 minutes" overreads the label. | LABEL (dosing instruction only) |
