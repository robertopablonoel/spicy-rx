...
import { FAQS } from "@/lib/content-eros";

/**
 * Single-open accordion — same Framer Motion pattern as the other lines. The
 * toggle glyph animates to var(--ember) (→ cyan under the Eros theme).
 */
export function FAQ() {
