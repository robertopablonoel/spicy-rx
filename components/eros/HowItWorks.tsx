...
import { HOW_IT_WORKS_STEPS } from "@/lib/content-eros";

/**
 * Three flat crater cards — identical layout to the other lines' HowItWorks,
 * with the Eros step copy from content-eros.
 */
