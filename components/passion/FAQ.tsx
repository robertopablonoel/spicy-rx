...
import { FAQS } from "@/lib/content-passion";

/**
 * Single-open accordion — same Framer Motion pattern as Hot Sauce's FAQ. The
 * toggle glyph animates to var(--ember) (→ rose under the Passion theme).
 */
export function FAQ() {
            ...
            <div key={f.q} className="border-b border-ash">
              ...
              >
                ...
                <motion.span
                  ...
                  animate={{
                    rotate: isOpen ? 45 : 0,
                    color: isOpen ? "var(--ember)" : "var(--fog)",
                  }}
