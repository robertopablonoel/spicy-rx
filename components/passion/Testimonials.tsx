...
import { TESTIMONIALS } from "@/lib/content-passion";

/**
 * Static 4-card grid — identical to Hot Sauce's Testimonials. Stars render in
 * --serum (soft rose-gold under the Passion theme), avatar circles use the
 * --grad-capsaicin var (→ plasma gradient). Quotes are woman-voiced peer
 * testimonials per the Addyi model.
 */
  ...
  return (
    ...
    >
      <div className="mb-14 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
        <div>
          <Eyebrow className="mb-4">Real women, real words</Eyebrow>
          <h2
