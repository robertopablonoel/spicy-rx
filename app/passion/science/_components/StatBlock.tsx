/**
 * Big-number stat used in the 2x2 grid on /passion/science.
 *
 * A theme-agnostic clone of the Hot Sauce StatBlock
 * (app/(marketing)/science/_components/StatBlock.tsx): identical structure,
 * driven entirely by CSS custom properties (--ember, --cosmos, --fog…), so it
 * renders plasma-pink automatically inside the [data-theme="passion"] wrapper.
 * Kept as its own copy to keep the /passion subtree self-contained rather than
 * reaching into another route's private _components.
 */
